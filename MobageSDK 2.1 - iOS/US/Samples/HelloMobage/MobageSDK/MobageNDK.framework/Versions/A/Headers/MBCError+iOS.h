...
extern "C" {
	...
	#define MBCCopyErrorIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructError((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyErrorArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructError_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
