...
extern "C" {
	...
	#define MBCCopyRemoteNotificationResponseIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructRemoteNotificationResponse((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyRemoteNotificationResponseArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructRemoteNotificationResponse_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
