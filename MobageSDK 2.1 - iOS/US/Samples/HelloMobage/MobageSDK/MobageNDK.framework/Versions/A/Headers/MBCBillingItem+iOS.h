...
extern "C" {
	...
	#define MBCCopyBillingItemIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructBillingItem((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyBillingItemArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructBillingItem_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
