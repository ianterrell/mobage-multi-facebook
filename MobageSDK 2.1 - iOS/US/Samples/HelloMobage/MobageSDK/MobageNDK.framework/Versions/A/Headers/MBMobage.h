 ...
 * fun-seekers that circles the globe. With the Native SDK, you can access a Mobage user's social
 * graph; sell virtual items to users; and harness Mobage's powerful analytics service.
 ...
 * <p>
 * For more information about the Native SDK, see the Programming Guide and <code>README</code>
 * file, which are packaged with the SDK.
 */
...
/**
 * Attempt to reestablish a session for the most recent user. The user will not be prompted for a
 ...
 * error.</li>
 * <li><code>sessionEstablished</code>: Set to <code>YES</code> if the session was reestablished or
 * <code>NO</code> if it was not reestablished.</li>
 * </ul>
 * @since 2.0
 */
+ (void) attemptToReestablishSessionWithCallbackQueue:(dispatch_queue_t)cbQueue
										   onComplete:(void(^)(MBSimpleAPIStatus status, NSObject<MBError> *error, BOOL sessionEstablished))completeCb;
