...
extern "C" {
	...
	#define MBCCopyRemoteNotificationPayloadIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructRemoteNotificationPayload((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyRemoteNotificationPayloadArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructRemoteNotificationPayload_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
