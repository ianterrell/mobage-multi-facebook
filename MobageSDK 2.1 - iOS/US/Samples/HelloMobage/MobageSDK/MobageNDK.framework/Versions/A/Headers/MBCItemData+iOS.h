...
extern "C" {
	...
	#define MBCCopyItemDataIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructItemData((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyItemDataArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructItemData_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
