...
#pragma mark Enums / Bitfields
	 ...
	 * Retrieve information about a leaderboard's top scores, starting with the highest score.
	 * You can use the <c>count</c> and <c>startIndex</c> parameters to control the
	 * number of results that this method retrieves, as well as the start index for the search
	 * results.
	 ...
	 * Retrieve information about a leaderboard's scores that were earned by the current user's friends, starting with the highest score.
	 * You can use the <c>count</c> and <c>startIndex</c> parameters to control the
	 * number of results that this method retrieves, as well as the start index for the search
	 * results.
