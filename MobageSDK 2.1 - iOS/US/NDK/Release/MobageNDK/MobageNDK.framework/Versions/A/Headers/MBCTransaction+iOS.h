...
extern "C" {
	...
	#define MBCCopyTransactionIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructTransaction((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyTransactionArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructTransaction_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
