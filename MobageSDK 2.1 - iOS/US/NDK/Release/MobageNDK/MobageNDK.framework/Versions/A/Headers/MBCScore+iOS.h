...
extern "C" {
	...
	#define MBCCopyScoreIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructScore((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyScoreArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructScore_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
