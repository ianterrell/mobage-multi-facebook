...
extern "C" {
	...
	#define MBCCopyUserIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructUser((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
	#define MBCCopyUserArrayIntoStructPtr(structPtr, objc, property) (structPtr)->property = MBCConstructUser_Array((__bridge void*)[((MBC_OBJC_CLASSNAME*)objc) property])
